...
- **SDP as a tool for quantum information:** At [QALYPSO 2026](https://qalypso.squarespace.com/advanced2026), I presented a three-hour introduction to semidefinite programming for quantum information. Here are the slides for [Lecture 1]({{ '/assets/talks/2026_09_03_QALYPSO_Lecture1.pdf' | relative_url }}), [Lecture 2]({{ '/assets/talks/2026_09_03_QALYPSO_Lecture2.pdf' | relative_url }}), and the [lecture notes]({{ '/assets/lecture%20notes/SDP%20QALYPSO2026.pdf' | relative_url }}).
- **SDPs and quantum information:** My main recommendation for learning about SDPs in quantum information is [*Semidefinite Programming in Quantum Information Science*](https://doi.org/10.1088/978-0-7503-3343-6) by Paul Skrzypczyk and Daniel Cavalcanti (2023). Chapter 3, which covers SDPs is [freely available on arXiv](https://arxiv.org/abs/2306.11637).
